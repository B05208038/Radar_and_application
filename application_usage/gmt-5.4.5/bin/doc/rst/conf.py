...
project = u'GMT'
copyright = u' '.join(['2019,', gmt_team])
...
latex_documents = [
  ...
  ('man_pages', 'GMT_Manpages.tex', u'GMT Man Pages',         gmt_team_tex, 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = '/mnt/d/GitLab_folder/Radar_and_application/application_usage/gmt-5.4.5/bin/doc/rst/_source/_images/GMT_coverlogo.pdf'
...
('pssolar', 'pssolar', 'Plot day-light terminators and other sunlight parameters', '', 1),
...
('psternary', 'psternary', 'Plot data on ternary diagrams', '', 1),
